...
from infrastructure.file.file_repository import FileRepository
from infrastructure.logging.logger import logger
from domain.entities.models import Album, Track
from infrastructure.llm.perplexity_client import PerplexityLLMClient
...
class CleanerService:
    ...
    def __init__(self, prompt_path: str, settings: Settings, to_new_dir: bool = True, llm_provider: str = "perplexity", max_retries: int = 3):
        ...
        if llm_provider == "deepseek":
            self.llm_client = DeepSeekLLMClient(prompt_path, settings)
        else:
            self.llm_client = PerplexityLLMClient(prompt_path, settings)
